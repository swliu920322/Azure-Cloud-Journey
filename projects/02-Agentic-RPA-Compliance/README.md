...
3. **Cognitive Compliance (RAG):** Black-box probability scores are legally void in financial compliance. For high-risk anomalies, the system triggers a Retrieval-Augmented Generation (RAG) module. It queries a vector database of active AML statutes and translates mathematical deviations into legally binding, human-readable audit trails.
...
* **Agentic RPA Pipeline Latency:** 515 seconds (8.5 minutes)
